...
<head>
  ...
  <title>KMS Dinas Komunikasi dan Informatika Provinsi Jawa Timur</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="arsha/assets/img/logo-prov jatim.png" rel="icon">
  <link href="arsha/assets/img/logo-prov jatim.png" rel="jatim-icon">
...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <a href="" class="logo me-auto"><img src="arsha/assets/img/logo.png" alt="" class="img-fluid"></a>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          ...
          <h2>Dinas Komunikasi dan Informatika <br> Provinsi Jawa Timur</h2>
  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <h6>Dinas Komunikasi dan Informatika Provinsi Jawa Timur</h6>
            <p>
              Jl. A. Yani 242 - 244, <br>
              Gayungan, <br>
              Kota Surabaya <br><br>
              <strong>Telp:</strong> (031) 8294608<br>
              <strong>Fax:</strong> (031) 8294517<br>
            </p>
          </div>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <div class="social-links mt-3">
              ...
              <a href="https://twitter.com/KominfoJatim" class="twitter"><i class="bx bxl-twitter"></i></a>
              <a href="https://www.linkedin.com/company/diskominfo-jatim/mycompany/" class="linkedin"><i class="bx bxl-linkedin"></i></a>
            </div>
          </div>
    ...
    <div class="container footer-bottom clearfix">
      <div class="copyright">
        &copy;  2022 Dinas Komunikasi dan Informatika
      </div>
      <div class="credits">
