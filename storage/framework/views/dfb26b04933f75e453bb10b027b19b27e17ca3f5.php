                ...
                <div class="card gradient-1">
                    <div class="card-body">
                        ...
                        <div class="d-inline-block">
                            <h2 class="text-white"><?php echo e($data1); ?></h2>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="card gradient-3">
                    <div class="card-body">
                        ...
                        <div class="d-inline-block">
                            <h2 class="text-white"><?php echo e($data); ?></h2>
                            <p class="text-white mb-0"></p>
                        </div>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="card gradient-4">
                    <div class="card-body">
                        ...
                        <div class="d-inline-block">
                            <h2 class="text-white"><?php echo e($data3); ?></h2>
                            <p class="text-white mb-0"></p>
                        </div>
...
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PKL\resources\views/diagram.blade.php ENDPATH**/ ?>